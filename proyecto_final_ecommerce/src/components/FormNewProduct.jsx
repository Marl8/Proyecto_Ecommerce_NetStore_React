  ...
  return (
    <form className='container-style' onSubmit={handleSubmit}>
      ...
      <div className='form-container'>
          ...
          <input
              type="text" className='form-input' name="nombre" value={product.nombre} onChange={handleChange} required />
              {errors.nombre && <p style={{ color: 'red' }}>{errors.nombre}</p>}
      </div>
      <div className='form-container'>
          <label className='form-label'>Precio:</label>
          <input type="number" className='form-input' name="precio" value={product.precio} onChange={handleChange} required
              min="0" />
      ...
      <button className='button-form' type="submit">Agregar Producto</button>
    </form>
  )
}
